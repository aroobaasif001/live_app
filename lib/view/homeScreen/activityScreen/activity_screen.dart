...
class ActivityScreen extends StatefulWidget {
  ...
  const ActivityScreen({Key? key, this.initialTab = 0}) : super(key: key);
...
class _ActivityScreenState extends State<ActivityScreen>
  ...
  void initState() {
    ...
    _tabController = TabController(
      length: 4,
      vsync: this,
      initialIndex: widget.initialTab, // set the initial tab index here
    );
  }
        ...
        actions: [
          Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(width: 1, color: const Color(0xffCACACA)),
            ),
            child: Padding(
