...
class ProductDetailScreen extends StatelessWidget {
              ...
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: Image.asset(
                    'assets/images/iphone.png', // Replace with actual image path
                    fit: BoxFit.cover,
                  ),
                ),
              ),
  ...
  Widget _buildProductDetails() {
    return Padding(
      ...
      child: ListView(
        children: [
          CustomTable(leftText: 'Selling price', rightText: '100,000 ₽'),
          ...
          CustomTable(leftText: 'Date of sale', rightText: 'September 25, 2022'),
          SizedBox(height: 20),
          CustomText(
            text: """Min: 2000 ₽, Max - 35000 ₽, Avg - 4048 ₽ AT THE GRAND GAME SHOW
