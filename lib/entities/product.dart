...
class Product {
  ...
  // Factory method to create a Product object from JSON (Firestore document)
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      id: json["id"],
      category: json["category"] ?? "",
      ...
      saleType: json["saleType"] ?? "Auction",
      startingBid: json["startingBid"]?.toDouble(),
      price: json["price"]?.toDouble(), // Fix: Was incorrectly assigned before
  ...
  // Converts Product object to JSON (for saving in Firestore)
  Map<String, dynamic> toJson() {
    return {
      "id": id,
      "category": category,
  ...
  // Firestore Collection Reference with Data Conversion
  static CollectionReference<Product> collection() {
